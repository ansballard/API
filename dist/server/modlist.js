...
modlistSchema.methods.generateHash = function (_password) {
	return _bcryptNodejs2.default.hashSync(_password, _bcryptNodejs2.default.genSaltSync(8), null);
};
...
modlistSchema.methods.shrinkArrays = function shrinkArrays() {
	...
	if (this.modlist && this.modlist.length > 0 && typeof this.modlist[0].name !== "undefined") {
		tempNew = [];
		for (var _i = 0; _i < this.modlist.length; _i++) {
			tempNew.push(this.modlist[_i].name);
		}
	...
	if (this.ini && this.ini.length > 0 && typeof this.ini[0].name !== "undefined") {
		tempNew = [];
		for (var _i2 = 0; _i2 < this.ini.length; _i2++) {
			tempNew.push(this.ini[_i2].name);
		}
		this.ini = tempNew;
		save = true;
	}
	if (this.prefsini && this.prefsini.length > 0 && typeof this.prefsini[0].name !== "undefined") {
		tempNew = [];
		for (var _i3 = 0; _i3 < this.prefsini.length; _i3++) {
			tempNew.push(this.prefsini[_i3].name);
		}
	...
	if (this.skse && this.skse.length > 0 && typeof this.skse[0].name !== "undefined") {
		tempNew = [];
		for (var _i4 = 0; _i4 < this.skse.length; _i4++) {
			tempNew.push(this.skse[_i4].name);
		}
		this.skse = tempNew;
		save = true;
	}
	if (this.enblocal && this.enblocal.length > 0 && typeof this.enblocal[0].name !== "undefined") {
		tempNew = [];
		for (var _i5 = 0; _i5 < this.enblocal.length; _i5++) {
			tempNew.push(this.enblocal[_i5].name);
		}
...
exports.default = _mongoose2.default.model("Modlist", modlistSchema);